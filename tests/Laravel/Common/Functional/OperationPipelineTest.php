...
use Thumbrise\Toolkit\Common\Functional\OperationPipeline;
use Thumbrise\Toolkit\Opresult\OperationResult;
use Thumbrise\Toolkit\Tests\Laravel\TestCase;

class OperationPipelineTest extends TestCase
{
    public function testProcess()
    {
        ...
        $actual = OperationPipeline::process($input, [
    ...
    public function testProcessOperationError()
    {
        ...
        $opresultActual = OperationPipeline::process($input, [
            function ($passable) use ($addit1) {
