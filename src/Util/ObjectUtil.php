...
class ObjectUtil
{
     ...
     *
     * @template T
     * @param object $from Исходный объект, из которого будут взяты значения.
     * @param T|object $to Целевой объект, в который будут записаны значения.
     * @param array $keysFromTo Массив, содержащий соответствие ключей между объектами $from и $to.
